 ...
 */
   ...
   /**
    ...
    function _unlink($resource, $exp_time = null)
    {
        ...
        // Rotina criada para evitar a remoção da pasta do svn do diretório dos templates compilados
        $expResourse =explode(".", $resource);

        if($expResourse[1] == "tpl" && $expResourse[2] == "php") {
